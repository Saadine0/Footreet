...
.form-control {
  ...
  .form-control:hover:not(:disabled):not([readonly])::-webkit-file-upload-button {
    background-color: #dde0e3; }
    #btn{
      background: linear-gradient(to right, #35bf68, #a2e5bb);
      color: white;
    }
    #btn1{
      background: linear-gradient(to right, #35bf68, #a2e5bb);
...
.btn-primary {
  ...
  .show > .btn-primary.dropdown-toggle {
    ...
    .show > .btn-primary.dropdown-toggle:focus {
      -webkit-box-shadow: 0 0 0 0.25rem #35bf68;
      box-shadow: 0 0 0 0.25rem #35bf68; }
  .btn-primary:disabled, .btn-primary.disabled {
    color: #000;
    background-color: #35bf68;
    border-color: #a2e5bb; }
...
.nav-tabs {
  border-bottom: 1px solid #35bf68; }
  .nav-tabs .nav-link {
    margin-bottom: -1px;
    background: none;
    border: 1px solid transparent;
...
.bg-gradient-primary {
  background: -webkit-gradient(linear, left top, right top, from(#a2e5bb), to(#35bf68)) !important;
  background: linear-gradient(to right, #35bf68, #a2e5bb) !important; }

.bg-gradient-secondary {
  background: -webkit-gradient(linear, left top, right top, from(#a2e5bb), to(#a2e5bb)) !important;
  background: linear-gradient(to right, #35bf68, #a2e5bb) !important; }
...
.bg-gradient-info {
  background: -webkit-gradient(linear, left top, right top, from(#a2e5bb), color-stop(99%, #a2e5bb)) !important;
  background: linear-gradient(to right, #35bf68, #a2e5bb 99%) !important; }
...
.bg-gradient-light {
  background: -webkit-gradient(linear, left top, left bottom, from(#a2e5bb), to(#a2e5bb)) !important;
  background: linear-gradient(to bottom, #35bf68, #a2e5bb) !important; }
